...
VertexType(
    _a::AbstractArray{T,4},
    _b::AbstractArray{T,4},
    _c::AbstractArray{T,4},
) where {T} = VertexType{T}(copy(_a), copy(_b), copy(_c))
...
StateType(_f_int::AbstractArray{T,1}, _γ::AbstractArray{T,2}, _Γ::VertexType{T}) where {T} =
